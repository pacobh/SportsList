...
//                }
    ...
    private <V extends UseCase.ResponseValue> void notifyError(final SportListResponseError responseError,
                                                               final UseCase.UseCaseCallback<V> useCaseCallback) {
    ...
    private static final class UiCallbackWrapper<V extends UseCase.ResponseValue> implements
        ...
        public void onError(SportListResponseError responseError) {
            mUseCaseHandler.notifyError(responseError,mCallback);
        }
    }
